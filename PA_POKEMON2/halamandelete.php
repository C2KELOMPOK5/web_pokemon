...
<body id="halaman_koleksi">
    <header id="header_duel">
        <nav>
          <ul>
            <li><a class="animate__animated animate__fadeInUp" href="index.php" >Keluar</a></li>
...
for (let i = 0; i < allCards.length; i++) {
  ...
  console.log(card.kartu);
  if (!imgElement) {
    
  console.log(`Could not find img element with alt value "${altValue}"`);
  console.log(`hi`);
  continue;
}
